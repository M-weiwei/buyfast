<template>
  <div>
    ...
    <el-dialog title="分配权限"
               :visible.sync="setDRightialogVisible"
               width="50%"
      ...
      <span slot="footer"
            class="dialog-footer">
        <el-button @click="setDRightialogVisible = false">取 消</el-button>
        <el-button type="primary"
...
export default {
  ...
  methods: {
    ...
    async removeRightById (role, rightId) {
      const removeResult = await this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
    ...
    async showSetRightDialog (role) {
      ...
      this.setDRightialogVisible = true
    },
    ...
    async  allotRights () {
      ...
      this.getRolesList()
      this.setDRightialogVisible = false
    },
    async addRole () {
